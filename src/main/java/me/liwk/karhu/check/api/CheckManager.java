...
public final class CheckManager {
   ...
   private final List rotationChecks;
   private final List positionChecks;
   private final List packetChecks;

   public CheckManager(KarhuPlayer karhuPlayer, Karhu karhu) {
      this.kp = karhuPlayer;
      List c = Arrays.asList(new AutoClickerA(karhuPlayer, karhu), new AutoClickerB(karhuPlayer, karhu), new AutoClickerC(karhuPlayer, karhu), new AutoClickerD(karhuPlayer, karhu), new AutoClickerE(karhuPlayer, karhu), new AutoClickerF(karhuPlayer, karhu), new AutoClickerG(karhuPlayer, karhu), new AutoClickerH(karhuPlayer, karhu), new AutoClickerI(karhuPlayer, karhu), new AutoClickerJ(karhuPlayer, karhu), new AutoClickerK(karhuPlayer, karhu), new AutoClickerL(karhuPlayer, karhu), new AutoClickerP(karhuPlayer, karhu), new AutoClickerU(karhuPlayer, karhu), new AutoClickerW(karhuPlayer, karhu), new VelocityA(karhuPlayer, karhu), new VelocityB(karhuPlayer, karhu), new ReachA(karhuPlayer, karhu), new HitboxA(karhuPlayer, karhu), new AimAssistA(karhuPlayer, karhu), new AimAssistB(karhuPlayer, karhu), new AimAssistC(karhuPlayer, karhu), new AimAssistD(karhuPlayer, karhu), new AimAssistE(karhuPlayer, karhu), new AimAssistF(karhuPlayer, karhu), new AimAssistG(karhuPlayer, karhu), new AimAssistH(karhuPlayer, karhu), new AimAssistI(karhuPlayer, karhu), new AimAssistJ(karhuPlayer, karhu), new AimAssistM(karhuPlayer, karhu), new AimAssistN(karhuPlayer, karhu), new AnalysisA(karhuPlayer, karhu), new AnalysisB(karhuPlayer, karhu), new AnalysisC(karhuPlayer, karhu), new AnalysisD(karhuPlayer, karhu), new AnalysisE(karhuPlayer, karhu), new AnalysisF(karhuPlayer, karhu), new KillauraA(karhuPlayer, karhu), new KillauraB(karhuPlayer, karhu), new KillauraC(karhuPlayer, karhu), new KillauraE(karhuPlayer, karhu), new KillauraF(karhuPlayer, karhu), new KillauraG(karhuPlayer, karhu), new KillauraH(karhuPlayer, karhu), new KillauraI(karhuPlayer, karhu), new KillauraJ(karhuPlayer, karhu), new KillauraK(karhuPlayer, karhu), new KillauraM(karhuPlayer, karhu), new KillauraN(karhuPlayer, karhu), new FlyA(karhuPlayer, karhu), new FlyB(karhuPlayer, karhu), new FlyC(karhuPlayer, karhu), new FlyD(karhuPlayer, karhu), new FlyE(karhuPlayer, karhu), new FlyF(karhuPlayer, karhu), new VehicleFly(karhuPlayer, karhu), new MotionA(karhuPlayer, karhu), new MotionB(karhuPlayer, karhu), new MotionC(karhuPlayer, karhu), new MotionD(karhuPlayer, karhu), new MotionE(karhuPlayer, karhu), new MotionF(karhuPlayer, karhu), new MotionI(karhuPlayer, karhu), new MotionJ(karhuPlayer, karhu), new StepA(karhuPlayer, karhu), new SpeedA(karhuPlayer, karhu), new SpeedB(karhuPlayer, karhu), new SpeedC(karhuPlayer, karhu), new OmniSprintA(karhuPlayer, karhu), new JesusA(karhuPlayer, karhu), new JesusB(karhuPlayer, karhu), new InventoryA(karhuPlayer, karhu), new InventoryB(karhuPlayer, karhu), new BadPacketsA(karhuPlayer, karhu), new BadPacketsB(karhuPlayer, karhu), new BadPacketsC(karhuPlayer, karhu), new BadPacketsD(karhuPlayer, karhu), new BadPacketsE(karhuPlayer, karhu), new BadPacketsF(karhuPlayer, karhu), new BadPacketsG(karhuPlayer, karhu), new BadPacketsH(karhuPlayer, karhu), new BadPacketsI(karhuPlayer, karhu), new BadPacketsJ(karhuPlayer, karhu), new BadPacketsK(karhuPlayer, karhu), new BadPacketsM(karhuPlayer, karhu), new BadPacketsN(karhuPlayer, karhu), new BadPacketsO(karhuPlayer, karhu), new BadPacketsQ(karhuPlayer, karhu), new BadPacketsR(karhuPlayer, karhu), new PingA(karhuPlayer, karhu), new TimerA(karhuPlayer, karhu), new TimerB(karhuPlayer, karhu), new TimerC(karhuPlayer, karhu), new ScaffoldA(karhuPlayer, karhu), new ScaffoldB(karhuPlayer, karhu), new ScaffoldC(karhuPlayer, karhu), new ScaffoldD(karhuPlayer, karhu), new ScaffoldE(karhuPlayer, karhu), new ScaffoldF(karhuPlayer, karhu), new ScaffoldG(karhuPlayer, karhu), new ScaffoldH(karhuPlayer, karhu), new ScaffoldI(karhuPlayer, karhu), new ScaffoldJ(karhuPlayer, karhu), new ScaffoldK(karhuPlayer, karhu), new ScaffoldL(karhuPlayer, karhu), new ScaffoldM(karhuPlayer, karhu), new ScaffoldN(karhuPlayer, karhu), new ScaffoldO(karhuPlayer, karhu), new ScaffoldP(karhuPlayer, karhu), new ScaffoldQ(karhuPlayer, karhu), new ScaffoldR(karhuPlayer, karhu), new FastBreakA(karhuPlayer, karhu), new FastBreakB(karhuPlayer, karhu), new FastBreakC(karhuPlayer, karhu), new GhostBreak(karhuPlayer, karhu), new BlockReach(karhuPlayer, karhu), new NoLookBreak(karhuPlayer, karhu), new GroundA(karhuPlayer, karhu), new GroundB(karhuPlayer, karhu), new GroundC(karhuPlayer, karhu), new Sensitivity(karhuPlayer, karhu), new Mouse(karhuPlayer, karhu));
      this.checks = (Check[])c.toArray(new Check[0]);
   ...
   public void runChecks(List paskat, Object e, Object packet) {
      ...
      while(true) {
         ...
         do {
            ...
            c = (Check)var6.next();
         } while(!Karhu.getInstance().getCheckState().isEnabled(c.getName()) && !c.isSilent());
   ...
   public Object getCheck(Class clazz) {
      return Arrays.stream(this.checks).filter((check) -> {
         return check.getClass() == clazz;
      }).findFirst().orElse((Object)null);
   }

   private List getAllOfType(Class clazz) {
      Stream var10000 = Arrays.stream(this.checks);
      clazz.getClass();
      return (List)var10000.filter(clazz::isInstance).collect(Collectors.toList());
   }

   public List getRotationChecks() {
      return this.rotationChecks;
   }

   public List getPositionChecks() {
      return this.positionChecks;
   }

   public List getPacketChecks() {
