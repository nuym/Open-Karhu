...
public final class StepA extends PositionCheck {
   ...
   public void handle(MovementUpdate update) {
      ...
      if (this.data.getVelocityY() > 0.0) {
         max = (float)Math.max((double)max, this.data.getVelocityY() + 0.4000000059604645);
      }
      ...
      boolean valid = !this.data.isOnPiston() && !this.data.isWasOnSlime() && !this.data.isPossiblyTeleporting() && !this.data.isSpectating() && this.data.elapsed(this.data.getLastPistonPush()) > 2 && this.data.levitationLevel == 0 && this.data.elapsed(this.data.getLastRiptide()) > 30 && this.data.elapsed(this.data.getLastGlide()) > 30 && this.data.elapsed(this.data.getLastFlyTick()) > 40;
