         ...
         if (packet instanceof BlockPlaceEvent) {
            ...
            if (pos.getX() != -1.0 && (pos.getY() != 255.0 || pos.getY() != -1.0) && pos.getZ() != -1.0) {
               BoundingBox hitbox = new BoundingBox(
                  this.data, targetPos.getX(), targetPos.getY(), targetPos.getZ(), targetPos.getX() + 1.0, targetPos.getY() + 1.0, targetPos.getZ() + 1.0
               );
               ...
               Vector eyeLocationFixed = new Vector(
                  this.data.getLastLocation().x,
                  this.data.getLastLocation().y + (double)(!this.data.isNewerThan12() ? sneakAmount1_8 : sneakAmount1_13),
                  this.data.getLastLocation().z
               );
